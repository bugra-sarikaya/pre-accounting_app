...
namespace pre_accounting_app {
    internal class button_return : Button {
        ...
        internal button_return(form_main form_main, Panel panel_current, panel_top panel_top) { // Constructor.
            ...
            vertical_gap = panel_top.height / 2;
            horizantal_gap = vertical_gap;
            mouse_down = false;
            Width = 82;
            Height = (int)(Width * 0.44f);
            Location = new Point(panel_top.width - vertical_gap - Width, (2 * panel_top.height - Height) / 2);
            Text = "Return";
        ...
        internal void event_handler_mouse_click(object sender, MouseEventArgs e) { // Calling main form method for changing panel.
