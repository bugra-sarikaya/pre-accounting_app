...
namespace pre_accounting_app {
    internal class panel_main : Panel {
        internal panel_main(form_main form) { // Constructor.
            ...
            button_main button_main_reports = new button_main(button_width, button_height, button_main_products.Location.X + button_main_products.Width + horizantal_gap, button_main_products.Location.Y, "Reports");
