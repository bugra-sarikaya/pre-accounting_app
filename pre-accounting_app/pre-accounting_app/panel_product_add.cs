    ...
    internal class panel_product_add : Panel {
        ...
        internal panel_product_add(form_main form_main, panel_top panel_top) { // Constructor.
           this.form_main = form_main;
            int initial_vertical_gap, second_vertical_gap, third_vertical_gap;
            initial_vertical_gap = 100;
            second_vertical_gap = (int)(initial_vertical_gap * 0.7f);
            third_vertical_gap = (int)(second_vertical_gap * 1.5f);
            Width = form_main.Width;
            Height = form_main.Height - panel_top.height;
            Name = "add_product";
            textbox_input_name = new textbox_input(200, 30, (Width - 200) / 2, initial_vertical_gap, "Name");
            ...
            button_submit_product_add = new button_submit_product_add(textbox_input_price.Width, textbox_input_price.Height, (Width - textbox_input_price.Width) / 2, textbox_input_price.Location.Y + third_vertical_gap, textbox_input_name, textbox_input_price, button_return);
