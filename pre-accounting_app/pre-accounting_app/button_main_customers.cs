...
namespace pre_accounting_app {
    internal class button_main_customers : button_main {
        ...
        internal button_main_customers(int x, int y, form_main form_current, Panel panel_current, panel_top panel_top) : base(x, y) { // Constructor.
            ...
            string address_icon_customers = "pictures\\icon_customers.png";
