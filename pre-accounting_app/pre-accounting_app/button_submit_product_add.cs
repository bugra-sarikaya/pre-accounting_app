...
namespace pre_accounting_app {
    internal class button_submit_product_add : Button {
        ...
        internal button_submit_product_add(int width, int height, int x, int y, textbox_input textbox_input_name, textbox_input textbox_code_product, textbox_input textbox_input_price, button_return button_return) { // Constructor.
            this.button_return = button_return;
            this.textbox_input_name = textbox_input_name;
            this.textbox_code_product = textbox_code_product;
        ...
        private void event_handler_click(object sender, EventArgs e) { // Inserting a new row to "product" table.
            ...
            sql_connection.Open();
            SqlCommand sql_command_insert = new SqlCommand("INSERT INTO products VALUES ('" + textbox_input_name.Text + "', '" + textbox_code_product.Text + "', '" + textbox_input_price.Text.Replace(",", ".") + "')", sql_connection);
