...
namespace pre_accounting_app {
    internal class button_submit_product_add : Button {
        ...
        internal button_submit_product_add(int width, int height, int x, int y, string text_submit, textbox_input textbox_input_name, textbox_input textbox_input_price, button_return button_return) { // Constructor.
