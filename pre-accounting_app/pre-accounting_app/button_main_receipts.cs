...
namespace pre_accounting_app {
    internal class button_main_receipts : button_main {
        ...
        internal button_main_receipts(int x, int y, form_main form_current, Panel panel_current, panel_top panel_top) : base(x, y) { // Constructor.
            ...
            string address_icon_customers = "pictures\\icon_receipts.png";
            ...
            picturebox_icon.Location = new Point(0, 0);
        ...
        private void event_handler_mouse_click(object sender, MouseEventArgs e) { // Calling main form method for changing panel.
            panel_next = new panel_receipts(form_current, panel_top);
