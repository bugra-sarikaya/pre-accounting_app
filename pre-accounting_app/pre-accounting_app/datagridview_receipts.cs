...
namespace pre_accounting_app {
    internal class datagridview_receipts : DataGridView {
        internal datagridview_receipts(int width, int height, int x, int y) { // Constructor.
            ...
            sql_connection.Open();
            SqlCommand sql_command_select = new SqlCommand("SELECT * FROM receipts ", sql_connection);
