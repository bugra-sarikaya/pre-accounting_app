...
namespace pre_accounting_app {
    internal class datagridview_customers : DataGridView {
        internal datagridview_customers(int width, int height, int x, int y) { // Constructor.
            ...
            sql_connection.Open();
            SqlCommand sql_command_select = new SqlCommand("SELECT * FROM customers", sql_connection);
